...
if do_plot_exp
    ...
    exp_dir   = '/users/skinnerr/NGC/Blowing_Profiles_S14.4.2_FromJeremy/';
    exp_file = 'P3_mdot1.25_300Hz.txt';

    % Load experimental data.
    exp_n_steps = 1000;
    exp_data = dlmread([exp_dir,exp_file],'\t',[1,0,exp_n_steps,3]);
    exp_t = exp_data(:,1);
    exp_umag = exp_data(:,3);
    exp_umag = exp_umag';
    ...
    settings.start_ts = 26;
    settings.end_ts   = length(exp_ts);
    settings.freq_Hz  = 300;
